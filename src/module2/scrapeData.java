...
class scrapeData {
	...
	//Tests for wordCount()
	@Test
	void wordCountTest() throws IOException, InterruptedException{
		//wordCount() is of type HashMap and I don't know how to test it because I have to
		//give it a hashmap of my own to expect.
